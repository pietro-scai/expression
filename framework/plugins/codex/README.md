...
- **Skills** — the same eight skills shipped in the Claude Code plugin,
  pulled from the canonical source at `src/sweet/skills/` in the main
  repo.
...
calls into the `sweet` CLI directly. We will revisit MCP in v2 if the
