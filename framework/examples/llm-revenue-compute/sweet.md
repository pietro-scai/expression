...
- `sweet overrides add arr_growth_2027_seed=1.0` — bull case: 2027 growth stays at 100%
- `sweet overrides add util_ceiling=0.60` — bear case: capacity never fully monetizes
- `sweet overrides add multiple_floor=5.0` — multiple compresses to pre-AI SaaS norms
- `sweet overrides add cap_2027=3.0` — capacity delays (permitting, power grid constraints)
- `sweet overrides add dc_twh_2030=1050` — GS accelerated scenario for global LLM market
