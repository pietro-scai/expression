...
_DEFAULT_SYSTEM_PREFIX = (
    ...
    "- Make ONE small change at a time, then run `sweet run` and check the "
    ...
    "  overrides via `sweet overrides add` (override-discipline skill).\n"
    "- After any code change, run `sweet test` and `sweet run`. Don't "
